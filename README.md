...
#### Запуск проекта в `Dev` версии через Docker Compose (на локальной машине)
Для запуска всех сервисов проекта используется [Docker Compose](https://docs.docker.com/engine/install/). В одной команде вы сможете запустить backend, frontend и базу данных.
...
3. Деплой приложения в контейнерах Docker:
